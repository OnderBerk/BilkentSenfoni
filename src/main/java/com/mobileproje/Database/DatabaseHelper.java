...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME="concertDB";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        Log.d("DATABASE OPERATIONS","OnCreate, table created"+ConcertDB.CREATE_TABLE_SQL);

        try {
            sqLiteDatabase.execSQL(ConcertDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(ConcertDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql , String...where){
        Cursor cursor = db.rawQuery("select * from "+ ConcertDB.TABLE_NAME,where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
